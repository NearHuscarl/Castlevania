...
<tileset version="1.2" tiledversion="1.2.1" name="Simon" tilewidth="60" tileheight="66" tilecount="40" columns="8">
 <image source="../Characters/Players/Simon.png" width="480" height="330"/>
 <tile id="0">
  <animation>
